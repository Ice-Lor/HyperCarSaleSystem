...
<section class="hero-banner text-center text-light d-flex align-items-center" style="min-height: 550px;">
    <div class="container py-5">
        ...
        <p class="lead mx-auto mb-4" style="max-width: 700px; color: #cbd5e1;">
...
<!-- Brand Logos -->
<section class="py-4 border-bottom border-secondary" style="background-color: #12131b;">
    <div class="container">
        <div class="row align-items-center text-center justify-content-center g-4">
            <c:forEach items="${brands}" var="b">
                <div class="col-6 col-md-3 col-lg-2">
                    <a href="${pageContext.request.contextPath}/cars?brandId=${b.brandId}" class="text-decoration-none d-block">
                        <img src="${pageContext.request.contextPath}/${b.logoUrl}" alt="${b.brandName}" style="height: 35px; filter: grayscale(100%) brightness(200%);" class="opacity-75">
    ...
    <div class="container py-4">
        <div class="d-flex justify-content-between align-items-end mb-4">
            <div>
                ...
                <h2 class="fw-bold mt-1 text-light" style="font-family: 'Cinzel', serif;">SIÊU XE NỔI BẬT</h2>
            </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card card-luxury h-100 position-relative">
                        ...
                        <div class="card-body p-4 d-flex flex-column">
                            <h5 class="fw-bold mb-1 text-light" style="font-family: 'Cinzel', serif;">${c.modelName}</h5>
                            <div class="small mb-3" style="color: #b0b3c0;">${c.categoryName} • Xuất xứ: ${c.brandCountry}</div>
                            
                            <!-- Specs Badges - FIX CONTRAST -->
                            <div class="row g-2 text-center small mb-3 py-2 rounded specs-row" style="background-color: #222436;">
                                <div class="col-4 border-end border-secondary">
                                    <i class="bi bi-lightning-charge-fill text-gold"></i>
                                    <div class="text-light">${c.horsepower} HP</div>
                                </div>
                                <div class="col-4 border-end border-secondary">
                                    <i class="bi bi-stopwatch text-gold"></i>
                                    <div class="text-light">${c.acceleration0100}s (0-100)</div>
                                </div>
                                <div class="col-4">
                                    <i class="bi bi-speedometer text-gold"></i>
                                    <div class="text-light">${c.topSpeed} km/h</div>
                                </div>
                            </div>

                            <div class="mt-auto d-flex justify-content-between align-items-center pt-2">
                                <div>
                                    <small style="color: #b0b3c0;" class="d-block">Giá niêm yết</small>
...
<section class="py-5 border-top border-bottom border-secondary my-4" style="background-color: var(--bg-card);">
    <div class="container py-3">
        <div class="row align-items-center g-4">
            <div class="col-lg-7">
                <span class="badge bg-gold text-dark mb-2">Đặc Quyền Thượng Lưu</span>
                <h3 class="fw-bold mb-3 text-light" style="font-family: 'Cinzel', serif;">Trải Nghiệm Lái Thử Trên Đường Đua Quốc Tế</h3>
                <p style="color: #b0b3c0;" class="mb-0">
